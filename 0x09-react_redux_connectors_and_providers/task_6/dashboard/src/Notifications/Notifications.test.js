...
describe("Notification tests", () => {
  ...
  it("verifies that setLoadingState, setNotifications, and fetchNotifications create the right actions", () => {
        const wrapper = shallow(<Notifications />);
        wrapper.instance().setLoadingState(true);
        wrapper.instance().setNotifications(listNotifications);
        wrapper.instance().fetchNotifications();

        // Add assertions here to check if the actions are dispatched correctly
    });

    it("verifies that SET_LOADING_STATE updates the reducer correctly", () => {
        // Assume your reducer function is named notificationsReducer
