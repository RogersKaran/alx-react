...
describe('Notification Selectors', () => {
  ...
  it('should return the list of unread urgent notifications when the filter is set to "URGENT"', () => {
    const stateWithUrgentFilter = { ...initialState, filter: 'URGENT' };
    expect(getUnreadNotifications(stateWithUrgentFilter)).toEqual([
      { id: 3, isRead: false, type: 'urgent', value: 'New data available' }
    ]);
  });
});
